...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i3.BaseExpenseRepository>(() => _i4.ExpenseRepositoryImpl());
    gh.factory<_i5.LoadExpensesForMonthUseCase>(() =>
        _i5.LoadExpensesForMonthUseCase(
            expenseRepository: gh<_i3.BaseExpenseRepository>()));
    gh.factory<_i6.DashboardCubit>(
        () => _i6.DashboardCubit(gh<_i5.LoadExpensesForMonthUseCase>()));
    return this;
  }
}
